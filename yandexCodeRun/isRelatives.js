...
/* 1. Инициализация
    ...
    3. Инициализация динамического программирования (DP) для поиска общей подстроки
       ...
       Динамическое программирование (DP) используется для эффективного поиска самой длинной общей
       подстроки (LCS - Longest Common Substring) между двумя строками genA и genB. В задаче
       мы проверяем, существует ли общая подстрока длины не менее minRequired (минимальной требуемой
       длины предковой цепочки P), чтобы подтвердить родство с учётом мутаций.
